...
const auditNames: Record<string, string> = {
  'issue.create': '创建议题', 'issue.edit': '编辑议题', 'issue.close': '关闭议题', 'issue.reopen': '重新开启议题', 'issue.archive': '归档议题', 'issue.vote_start': '开始投票', 'issue.vote_end': '结束投票', 'issue.vote_end_auto': '自动结束投票', 'issue.outcome.confirm': '确认议题结果', 'vote.cast': '提交投票', 'comment.create': '发表意见', 'comment.edit': '编辑意见', 'comment.reaction': '回应意见', 'comment.reply': '回复意见',
