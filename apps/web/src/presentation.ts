...
const auditNames: Record<string, string> = {
  'issue.create': '创建议题', 'issue.edit': '编辑议题', 'issue.close': '关闭议题', 'issue.reopen': '重新开启议题', 'issue.archive': '归档议题', 'vote.cast': '提交投票', 'comment.create': '发表意见', 'comment.edit': '编辑意见', 'comment.reaction': '回应意见',
